const CITY_LABELS = [
  { lat: 25.7907, lng: -80.1340, key: "RIVA", kind: "zone", z: 10 },
  { lat: 25.7617, lng: -80.1918, key: "CENTRO", kind: "zone", z: 10 },
  { lat: 25.8065, lng: -80.1250, key: "NEON", kind: "zone", z: 10 },
  { lat: 25.7780, lng: -80.1870, key: "DARSENA", kind: "zone", z: 10 },
  { lat: 25.7950, lng: -80.2760, key: "PISTA", kind: "zone", z: 10 },
  { lat: 25.7320, lng: -80.2440, key: "GIARDINI", kind: "zone", z: 11 },
  { lat: 25.8500, lng: -80.1750, key: "DUNE", kind: "zone", z: 11 },
  { lat: 25.7310, lng: -80.1620, key: "ISOLE", kind: "zone", z: 11 },
  { lat: 25.8680, lng: -80.1220, key: "NORD", kind: "zone", z: 11 },
...
const LAB = {
  ...
  fr: { RIVA:"RIVE", CENTRO:"CENTRE", NEON:"NEON", DARSENA:"QUAIS", PISTA:"PISTE", GIARDINI:"JARDINS", DUNE:"DUNES", ISOLE:"ILES", NORD:"NORD", CORAL:"CORAL AVE", RIVA_DR:"RIVE DRIVE", BAIA:"BAIE BLVD", HW7:"AUTOROUTE 7", PONTE:"PONT EST", TORRI:"RUE TOURS", PALME:"RUE PALMIERS", LITO:"LITTORAL", SUD:"BOUCLE SUD", VIA_PISTA:"VOIE PISTE", CLUB:"Club Palme", MOLO:"Mole 12", HOTEL:"Hotel Rosa", STAT:"Gare", INS:"Enseignes", SPIA:"Plage Sud", TERM:"Terminal", PORTO:"Port" },
  de: { RIVA:"UFER", CENTRO:"ZENTRUM", NEON:"NEON", DARSENA:"HAFEN", PISTA:"PISTE", GIARDINI:"GARTEN", DUNE:"DUNEN", ISOLE:"INSELN", NORD:"NORD", CORAL:"CORAL AVE", RIVA_DR:"UFER DRIVE", BAIA:"BAY BLVD", HW7:"AUTOBAHN 7", PONTE:"OSTBRUCKE", TORRI:"TURMSTR", PALME:"PALMENSTR", LITO:"KUSTE", SUD:"SUDRING", VIA_PISTA:"PISTENWEG", CLUB:"Palm Club", MOLO:"Pier 12", HOTEL:"Hotel Rosa", STAT:"Bahnhof", INS:"Schilder", SPIA:"Sudstrand", TERM:"Terminal", PORTO:"Hafen" },
  pt: { RIVA:"MARGEM", CENTRO:"CENTRO", NEON:"NEON", DARSENA:"DOCAS", PISTA:"PISTA", GIARDINI:"JARDINS", DUNE:"DUNAS", ISOLE:"ILHAS", NORD:"NORTE", CORAL:"CORAL AVE", RIVA_DR:"MARGEM DR", BAIA:"BAIA BLVD", HW7:"AUTOESTRADA 7", PONTE:"PONTE ESTE", TORRI:"RUA TORRES", PALME:"ESTRADA PALMAS", LITO:"LITORAL", SUD:"ANEL SUL", VIA_PISTA:"VIA PISTA", CLUB:"Clube Palma", MOLO:"Cais 12", HOTEL:"Hotel Rosa", STAT:"Estacao", INS:"Letreiros", SPIA:"Praia Sul", TERM:"Terminal", PORTO:"Porto" },
  ja: { RIVA:"SHORE", CENTRO:"DOWNTOWN", NEON:"NEON", DARSENA:"DOCKS", PISTA:"AIRFIELD", GIARDINI:"GARDENS", DUNE:"DUNES", ISOLE:"ISLANDS", NORD:"NORTH", CORAL:"CORAL AVE", RIVA_DR:"SHORE DR", BAIA:"BAY BLVD", HW7:"HWY 7", PONTE:"EAST BRIDGE", TORRI:"TOWER ST", PALME:"PALM ROAD", LITO:"COAST", SUD:"SOUTH LOOP", VIA_PISTA:"AIRFIELD RD", CLUB:"Palm Club", MOLO:"Pier 12", HOTEL:"Hotel Rosa", STAT:"Station", INS:"Neon", SPIA:"South Beach", TERM:"Terminal", PORTO:"Port" }
};

function labName(item) {
  const lang = localStorage.getItem("p72_lang") || "it";
  return (LAB[lang] && LAB[lang][item.key]) || LAB.it[item.key] || item.key;
}
...
function labelIcon(item) {
  ...
  return L.divIcon({
    ...
    html: '<span class="map-lab" data-kind="' + item.kind + '" data-key="' + item.key + '" style="' + rot + '">' + labName(item) + "</span>",
    iconSize: [1, 1],
    iconAnchor: [0, 0]
  });
}
...
function refreshLabelText() {
  document.querySelectorAll(".map-lab[data-key]").forEach(function (el) {
    const key = el.getAttribute("data-key");
    const lang = localStorage.getItem("p72_lang") || "it";
    el.textContent = (LAB[lang] && LAB[lang][key]) || LAB.it[key] || key;
  });
}

function addCityLabels(target) {
  if (!target || target._labels) {
    refreshLabelText();
    return;
  }
  target._labels = [];
